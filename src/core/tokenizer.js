function tokenize(code) {
    ...
    while (i < len) {
        ...
        if ((c >= 97 && c <= 122) || (c >= 65 && c <= 90) || c === 95 || c >= 192) {
            if ((c === 162 || c === 163 || c === 164 || c === 165 || c === 167 || c === 172 || c === 176 || c === 177 || c === 181 || c === 182 || c === 215 || c === 247)) {
            ...
            while (i < len) {
                const ch = code.charCodeAt(i);
                if ((ch >= 97 && ch <= 122) || (ch >= 65 && ch <= 90) || (ch >= 48 && ch <= 57) || ch === 95 || ch >= 192) {
                    i++;
                } else {
                    break;
                }
        ...
        if (c === 40 || c === 41 || c === 123 || c === 125 || c === 91 || c === 93 || c === 44 || c === 59 || c === 46 || c === 61 || c === 43 || c === 45 || c === 42 || c === 47 || c === 37 || c === 60 || c === 62 || c === 33 || c === 38 || c === 124 || c === 58 || c === 63) {
            const char = code[i];
            if (c === 40 || c === 123 || c === 91) {
        ...
        state.currentLine = line;
        error('Unexpected character "' + code[i] + '" (Unicode: U+' + c.toString(16).toUpperCase().padStart(4, '0') + ')');
    }
